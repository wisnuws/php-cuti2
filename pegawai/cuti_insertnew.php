...
if($durasi>$jml){
	echo "<script type='text/javascript'>
			...
			document.location = 'new_cuti.php'; 
		</script>";	
}else{
	$sql 	= "INSERT INTO cuti_luar (no_cuti, npp, tgl_pengajuan, tgl_awal, tgl_akhir, durasi, keterangan, leader, stt_cuti) 
				VALUES ('$id','$npp','$ajuan','$mulai','$akhir','$durasi','$ket','$leader','$stt')";
	$query 	= mysqli_query($conn,$sql);
	if($query){
		echo "<script type='text/javascript'>
				alert('Pengajuan cuti berhasil!'); 
				document.location = 'cuti-waitappnew.php'; 
			</script>";
