                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. Jasamarga Transawatol</b></h4>
						...
						<?php 
						if(isset($menuparent) && $menuparent == "buatcuti") {
						...
						?>
							...
							<a href="#"><i class="fa fa-book fa-fw"></i>&nbsp;Pengajuan Cuti<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Buat Pengajuan Cuti Tahunan") {
										echo '<li><a href="cuti_create.php" class="active">Buat Pengajuan Cuti Tahunan</a></li>';
									}
									else {
										echo '<li><a href="cuti_create.php">Buat Pengajuan Cuti Tahunan</a></li>';
									}
									if($pagedesc == "Buat Pengajuan Cuti Diluar Tahunan") {
										echo '<li><a href="new_cuti.php" class="active">Buat Pengajuan Cuti Diluar Tahunan</a></li>';
									}
									else {
										echo '<li><a href="new_cuti.php">Buat Pengajuan Cuti Diluar Tahunan</a></li>';
									// }<!-- /.nav-second-level -->
								}
								?>
							</ul>
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-recycle fa-fw"></i>&nbsp;Status Cuti T<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-exclamation-triangle fa-fw"></i>&nbsp;Status Cuti LT<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Menunggu Approval cuti new") {
										echo '<li><a href="cuti-waitappnew.php" class="active">Menunggu Approval</a></li>';
									}
									else {
										echo '<li><a href="cuti-waitappnew.php">Menunggu Approval</a></li>';
									}
									if($pagedesc == "Rejected New") {
										echo '<li><a href="cuti_rejectnew.php" class="active">Rejected</a></li>';
									}
									else {
										echo '<li><a href="cuti_rejectnew.php">Rejected</a></li>';
									}
									if($pagedesc == "Approved new") {
										echo '<li><a href="cuti_appnew.php" class="active">Approved</a></li>';
									}
									else {
										echo '<li><a href="cuti_appnew.php">Approved</a></li>';
									}
								?>
							</ul>
						</li>
