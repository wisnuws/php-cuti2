<?php
	...
	// deskripsi halaman
	$pagedesc = "Menunggu Approval cuti new";
            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp AND cuti_luar.stt_cuti !='Rejected' AND cuti_luar.stt_cuti !='Approved'
									    AND cuti_luar.npp='$id' ORDER BY cuti_luar.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="cuti_hapusnew.php?no=<?php echo $data['no_cuti'];?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan cuti No. <?php echo $data['no_cuti'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
...
<script type="text/javascript">
	...
	<script>
		...
		$('[data-load-code]').on('click',function(e) {
					...
					if(code) {
						$($this.data('remote-target')).load('cuti_detailnew.php?code='+code);
						app.code = code;
