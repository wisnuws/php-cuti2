            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp ORDER BY cuti_luar.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  if($data['hrd_app']==1){
														  ?>
														  <a href="app_cetakformE.php?no=<?php echo $data['no_cuti'];?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a>
													<?php
