<?php
	...
	$sql_wait1 = "SELECT no_cuti FROM cuti_luar WHERE stt_cuti='Menunggu Approval Admin'";
	$ress_wait1 = mysqli_query($conn, $sql_wait1);
	$wait1 = mysqli_num_rows($ress_wait1);
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										...
										<div><h4>Menunggu Approval T</h4></div>
									</div>
								</div>
							</div>
							<a href="app_wait.php">
						...
						<div class="panel panel-red">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										<div class="huge"><?php echo $wait1; ?></div>
										<div><h4>Menunggu Approval LT</h4></div>
									</div>
								</div>
							</div>
							<a href="app_waitnew.php">
								<div class="panel-footer">
									<span class="pull-left">Lihat Rincian</span>
									<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
									<div class="clearfix"></div>
