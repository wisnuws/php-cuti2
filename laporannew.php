						...
						<?php
							if(isset($_GET['submit'])){
								...
								$sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp 
										AND cuti_luar.tgl_pengajuan BETWEEN '$mulai' AND '$selesai' ORDER BY cuti_luar.tgl_pengajuan DESC";
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="form-group">
									<a href="laporan_cetak_new.php?awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>" target="_blank" class="btn btn-warning">Cetak</a>
							</div>
							</div>
			<!-- Large modal -->
