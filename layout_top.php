...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online PT. Jasamarga Transjawatol - <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="libs/images/jm.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. Jasamarga Transjawatol</strong></div>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. Jasamarga Transjawatol</b></h4>
						...
						?>
						<!-- open <li> tag generated with php, see line 134-139 -->
							<a href="#"><i class="fa fa-pencil fa-fw"></i>&nbsp;Cuti<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
								if($pagedesc == "CutiAll") {
									echo '<li><a href="updatecutiall.php" class="active">Update All Cuti Karyawan</a></li>';
								}
								else {
									echo '<li><a href="updatecutiall.php">Update All Cuti Karyawan</a></li>';
								}
								if($pagedesc == "cutibersama") {
									echo '<li><a href="cutibersama.php" class="active">Cuti Bersama</a></li>';
								}
								else {
									echo '<li><a href="cutibersama.php">Cuti Bersama</a></li>';
								}
								?>							
							</ul><!-- /.nav-second-level -->
						</li>
						...
						<!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-download fa-fw"></i>&nbsp;Approval T<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
						...
						?>
						<!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-exclamation-triangle fa-fw"></i>&nbsp;Approval LT<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
								if($pagedesc == "Waiting Approval New") {
									echo '<li><a href="app_waitnew.php" class="active">Menunggu Approval</a></li>';
								}
								else {
									echo '<li><a href="app_waitnew.php">Menunggu Approval</a></li>';
								}
								if($pagedesc == "Approved New") {
									echo '<li><a href="appnew.php" class="active">Approved</a></li>';
								}
								else {
									echo '<li><a href="appnew.php">Approved</a></li>';
								}
								if($pagedesc == "Semua Data New") {
									echo '<li><a href="app_allnew.php" class="active">Semua Data</a></li>';
								}
								else {
									echo '<li><a href="app_allnew.php">Semua Data</a></li>';
								}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
							...
							<!-- open <li> tag generated with php, see line 155-160 -->
								...
								<ul class="nav nav-second-level">
									<?php
									if($pagedesc == "Laporan") {
										echo '<li><a href="laporan.php" class="active">Laporan T</a></li>';
									}
									else {
										echo '<li><a href="laporan.php">Laporan T</a></li>';
									}
									if($pagedesc == "Laporan") {
										echo '<li><a href="laporannew.php" class="active">Laporan LT</a></li>';
									}
									else {
										echo '<li><a href="laporannew.php">Laporan LT</a></li>';
									}
									?>
								</ul><!-- /.nav-second-level -->
							</li>
