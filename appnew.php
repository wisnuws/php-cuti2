					...
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp AND 
										cuti_luar.hrd_app='1' ORDER BY cuti_luar.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="app_cetakformE.php?no=<?php echo $data['no_cuti'];?>" target="_blank" class="btn btn-primary btn-xs">Cetak</a></td>
												<?php
												echo '</td>';
												echo '</tr>';												
												$i++;
