<?php
	...
	$now = date('Y-m-d');
	$Sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp AND cuti_luar.no_cuti='$_GET[no]'";
...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" name="cuti" action="approval_updatenew.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">
