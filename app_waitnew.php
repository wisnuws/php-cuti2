            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp AND 
										cuti_luar.stt_cuti='Menunggu Approval Admin' ORDER BY cuti_luar.tgl_pengajuan DESC";
										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  ...
													  <a href="approval_reviewnew.php?no=<?php echo $data['no_cuti'];?>" class="btn btn-primary btn-xs">Review</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
