...
if($_GET) {
	$kode = $_GET['code'];
	$sql = "SELECT cuti_luar.*, employee.* FROM cuti_luar, employee WHERE cuti_luar.npp=employee.npp AND cuti_luar.no_cuti='". $_GET['code'] ."'";
	$query = mysqli_query($conn,$sql);
	$result = mysqli_fetch_array($query);
	$sql2 = "SELECT * FROM `cuti` WHERE hrd_app = 1 and npp = ".$result['npp']."";
...
<table width="100%">
	...
	<tr>
		...
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['jml_cuti'] ?> Hari</td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
